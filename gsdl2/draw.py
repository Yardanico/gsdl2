from gsdl2.surface import locked
from gsdl2.color import create_color
from gsdl2.rect import Rect
from gsdl2 import sdl, ffi
import gsdl2.surface

import math


def _check_surface(surface):
    if not isinstance(surface, gsdl2.surface.Surface):
...
def _drawhorizline(surface, c_color, start_x, end_x, y):
    ...
    sdlrect.h = 1
    sdl.fillRect(surface.sdl_surface, sdlrect, c_color)
...
def line(surface, color, start, end, width=1):
    ...
    c_color = create_color(color, surface.sdl_surface.format)
