...
ParticleEngine by marcusva in py-sdl2:
...
class ParticleEngine(object):
    ...
    def process(self, dt, world, components):
        ...
        for p in components:
            ...
            if p.life <= 0:
                dappend(p)
        self.createfunc(dt, world, deadones)
        self.updatefunc(dt, world, set(components) - set(deadones))
        self.deletefunc(dt, world, deadones)
