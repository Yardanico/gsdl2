...
if is_pygame_pkg:
    from gsdl2.tests.test_utils import unittest
else:
    from test.test_utils import unittest

import tempfile, sys, gsdl2, time, os
...
def test():
    ...
    if is_pygame_pkg:
        module = 'gsdl2.tests.test_utils.unittest'
    else:
