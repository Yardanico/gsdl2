"""Load and run the gsdl2 test suite

python -c "import gsdl2.tests.go" [<test options>]
...
if is_pygame_pkg:
    from gsdl2.tests.test_utils.run_tests import run_and_exit
    from gsdl2.tests.test_utils.test_runner import opt_parser
else:
    from test.test_utils.run_tests import run_and_exit
    from test.test_utils.test_runner import opt_parser

if is_pygame_pkg:
    test_pkg_name = "gsdl2.tests"
else:
    test_pkg_name = "test"
