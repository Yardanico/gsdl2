...
class MouseModuleTest(unittest.TestCase):
    def todo_test_get_cursor(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mouse.get_cursor:

          # gsdl2.mouse.get_cursor(): return (size, hotspot, xormasks, andmasks)
    ...
    def todo_test_get_focused(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mouse.get_focused:

          # gsdl2.mouse.get_focused(): return bool
          # check if the display is receiving mouse input
          # 
          # Returns true when gsdl2 is receiving mouse input events (or, in
          ...
          # gsdl2.mouse.get_focused() indicates whether the gsdl2 window
    ...
    def todo_test_get_pos(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mouse.get_pos:

          # gsdl2.mouse.get_pos(): return (x, y)
    ...
    def todo_test_get_pressed(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mouse.get_pressed:

          # gsdl2.moouse.get_pressed(): return (button1, button2, button3)
          ...
          #  gsdl2.event.wait() or gsdl2.event.get() and check all of those events
          ...
          # be emitted.
          # 
          # Note, remember to call gsdl2.event.get() before this function.
    ...
    def todo_test_get_rel(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mouse.get_rel:

          # gsdl2.mouse.get_rel(): return (x, y)
    ...
    def todo_test_set_cursor(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mouse.set_cursor:

          # gsdl2.mouse.set_cursor(size, hotspot, xormasks, andmasks): return None
          ...
          # is raised.
          # 
          # See the gsdl2.cursor module for help creating default and custom
    ...
    def todo_test_set_pos(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mouse.set_pos:

          # gsdl2.mouse.set_pos([x, y]): return None
    ...
    def todo_test_set_visible(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mouse.set_visible:

          # gsdl2.mouse.set_visible(bool): return bool
