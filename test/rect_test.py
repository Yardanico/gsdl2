...
class RectTypeTest( unittest.TestCase ):
    ...
    def test_collidedict(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.rect.Rect.collidedict:
    ...
    def test_collidedictall(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.rect.Rect.collidedictall:
    ...
    def test_collidelist(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.rect.Rect.collidelist:
    ...
    def test_collidelistall(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.rect.Rect.collidelistall:
    ...
    def test_fit(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.rect.Rect.fit:
