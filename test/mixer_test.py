...
if is_pygame_pkg:
    from gsdl2.tests.test_utils import unittest, example_path, expected_error
else:
    from test.test_utils import unittest, example_path, expected_error
import gsdl2
from gsdl2 import mixer
from gsdl2.compat import xrange_, unicode_, geterror, bytes_
...
##                    for c in CHANNELS )
    ...
    def test_quit(self):
        """ get_num_channels() Should throw gsdl2.error if uninitialized
        after mixer.quit() """
        ...
        self.assertRaises (
            gsdl2.error, mixer.get_num_channels,
        )
    ...
    def test_sound_args(self):
        ...
        try:
            ...
            self.assertRaises(gsdl2.error, mixer.Sound, ufake_path)
            try:
    ...
    def test_array_interface(self):
        ...
        try:
            ...
            if gsdl2.get_sdl_byteorder() == gsdl2.LIL_ENDIAN:
                typestr = '<i2'
            else:
                typestr = '>i2'
    ...
    def todo_test_fadeout(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.fadeout:

          # gsdl2.mixer.fadeout(time): return None
    ...
    def todo_test_find_channel(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.find_channel:

          # gsdl2.mixer.find_channel(force=False): return Channel
          ...
          #
          # If the mixer has reserved channels from gsdl2.mixer.set_reserved()
    ...
    def todo_test_get_busy(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.get_busy:

          # gsdl2.mixer.get_busy(): return bool
    ...
    def todo_test_init(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.init:

          # gsdl2.mixer.init(frequency=22050, size=-16, channels=2,
          ...
          # power of two.
          #
          # Some platforms require the gsdl2.mixer module to be initialized
          # after the display modules have initialized. The top level
          # gsdl2.init() takes care of this automatically, but cannot pass any
          # arguments to the mixer init. To solve this, mixer has a function
          # gsdl2.mixer.pre_init() to set the proper defaults before the
    ...
    def todo_test_pause(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.pause:

          # gsdl2.mixer.pause(): return None
    ...
    def todo_test_pre_init(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.pre_init:

          # gsdl2.mixer.pre_init(frequency=0, size=0, channels=0,
          # buffersize=0): return None
          #
          # preset the mixer init arguments
          #
          # Any nonzero arguments change the default values used when the real
          # gsdl2.mixer.init() is called. The best way to set custom mixer
          # playback values is to call gsdl2.mixer.pre_init() before calling
          # the top level gsdl2.init().
          #
    ...
    def todo_test_set_reserved(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.set_reserved:

          # gsdl2.mixer.set_reserved(count): return None
    ...
    def todo_test_stop(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.stop:

          # gsdl2.mixer.stop(): return None
    ...
    def todo_test_unpause(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.unpause:

          # gsdl2.mixer.unpause(): return None
...
class ChannelTypeTest(unittest.TestCase):
    def todo_test_Channel(self):
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Channel:

          # gsdl2.mixer.Channel(id): return Channel
          # Create a Channel object for controlling playback
          #
          # Return a Channel object for one of the current channels. The id must
          # be a value from 0 to the value of gsdl2.mixer.get_num_channels().
          #
          ...
          # channels is entirely optional since gsdl2 can manage them by
          # default.
          #
    ...
    def todo_test_fadeout(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Channel.fadeout:
    ...
    def todo_test_get_busy(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Channel.get_busy:
    ...
    def todo_test_get_endevent(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Channel.get_endevent:
    ...
    def todo_test_get_queue(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Channel.get_queue:
    ...
    def todo_test_get_sound(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Channel.get_sound:
    ...
    def todo_test_get_volume(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Channel.get_volume:
    ...
    def todo_test_pause(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Channel.pause:
    ...
    def todo_test_play(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Channel.play:
    ...
    def todo_test_queue(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Channel.queue:
    ...
    def todo_test_set_endevent(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Channel.set_endevent:
          ...
          # gsdl2 queue every time a sound finishes playing on that channel
          # (not just the first time). Use gsdl2.event.get() to retrieve the
          ...
          # gsdl2.locals.USEREVENT and gsdl2.locals.NUMEVENTS. If no type
    ...
    def todo_test_set_volume(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Channel.set_volume:
    ...
    def todo_test_stop(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Channel.stop:
    ...
    def todo_test_unpause(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Channel.unpause:
...
class SoundTypeTest(unittest.TestCase):
    def todo_test_fadeout(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Sound.fadeout:
    ...
    def todo_test_get_length(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Sound.get_length:
    ...
    def todo_test_get_num_channels(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Sound.get_num_channels:
    ...
    def todo_test_get_volume(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Sound.get_volume:
    ...
    def todo_test_play(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Sound.play:
    ...
    def todo_test_set_volume(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Sound.set_volume:
    ...
    def todo_test_stop(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.mixer.Sound.stop:
