...
if is_pygame_pkg:
    ...
    from gsdl2.tests.test_utils import (
        ...
        example_path)
    try:
        from gsdl2.tests.test_utils.arrinter import *
    except ImportError:
        pass
else:
...
from gsdl2.compat import xrange_
...
class SurfaceTypeTest(unittest.TestCase):
    def test_set_clip( self ):
        ...
        """
        s = gsdl2.Surface((800, 600))
        r = gsdl2.Rect(10, 10, 10, 10)
        s.set_clip(r)
        r.move_ip(10, 0)
        s.set_clip(None)
        res = s.get_clip()
    ...
    def test_print(self):
        surf = gsdl2.Surface((70,70), 0, 32)
        self.assertEqual(repr(surf), '<Surface(70x70x32 SW)>')

    def test_keyword_arguments(self):
        surf = gsdl2.Surface((70,70), flags=SRCALPHA, depth=32)
        ...
        surf_16 = gsdl2.Surface((70,70), 0, 16)
        self.assertEqual(surf_16.get_bytesize(), 2)

        # try again with an argument list
        surf_16 = gsdl2.Surface((70,70), depth=16)
        self.assertEqual(surf_16.get_bytesize(), 2)

    def test_set_at(self):

        #24bit surfaces
        s = gsdl2.Surface( (100, 100), 0, 24)
        s.fill((0,0,0))

        # set it with a tuple.
        s.set_at((0,0), (10,10,10, 255))
        r = s.get_at((0,0))
        self.failUnless(isinstance(r, gsdl2.Color))
    ...
    def test_masks(self):
        ...
        # For 24 and 32 bit surfaces gsdl2 assumes no losses.
    ...
    def test_copy(self):
        ...
        # __doc__ (as of 2008-06-25) for gsdl2.surface.Surface.copy:

          # Surface.copy(): return Surface
          # create a new copy of a Surface

        color = (25, 25, 25, 25)
        s1 = gsdl2.Surface((32,32), gsdl2.SRCALPHA, 32)
        s1.fill(color)
    ...
    def test_fill(self):
        ...
        # __doc__ (as of 2008-06-25) for gsdl2.surface.Surface.fill:

          # Surface.fill(color, rect=None, special_flags=0): return Rect
          # fill Surface with a solid color

        color = (25, 25, 25, 25)
        fill_rect = gsdl2.Rect(0, 0, 16, 16)
    ...
    def test_fill_negative_coordinates(self):
        ...
        color = (25, 25, 25, 25)
        color2 = (20, 20, 20, 25)
        fill_rect = gsdl2.Rect(-10, -10, 16, 16)
    ...
    def test_fill_keyword_args(self):
        color = (1, 2, 3, 255)
        area = (1, 1, 2, 2)
        s1 = gsdl2.Surface((4, 4), 0, 32)
        s1.fill(special_flags=gsdl2.BLEND_ADD, color=color, rect=area)
    ...
    def test_get_alpha(self):
        ...
        # __doc__ (as of 2008-06-25) for gsdl2.surface.Surface.get_alpha:
    ...
    def test_get_bytesize(self):
        ...
        # __doc__ (as of 2008-06-25) for gsdl2.surface.Surface.get_bytesize:
    ...
    def test_get_flags(self):
        ...
        # __doc__ (as of 2008-06-25) for gsdl2.surface.Surface.get_flags:

          # Surface.get_flags(): return int
          # get the additional flags used for the Surface

        s1 = gsdl2.Surface((32,32), gsdl2.SRCALPHA, 32)
        self.assert_(s1.get_flags() == gsdl2.SRCALPHA)
    ...
    def test_get_parent(self):
        ...
        # __doc__ (as of 2008-06-25) for gsdl2.surface.Surface.get_parent:

          # Surface.get_parent(): return Surface
          # find the parent of a subsurface

        parent = gsdl2.Surface((16, 16))
    ...
    def test_get_rect(self):
        ...
        # __doc__ (as of 2008-06-25) for gsdl2.surface.Surface.get_rect:

          # Surface.get_rect(**kwargs): return Rect
          # get the rectangular area of the Surface

        surf = gsdl2.Surface((16, 16))
    ...
    def test_get_width__size_and_height(self):
        ...
        # __doc__ (as of 2008-06-25) for gsdl2.surface.Surface.get_width:
    ...
    def test_get_view(self):
        ...
        s = gsdl2.Surface((5, 7), gsdl2.SRCALPHA, 16)
        v = s.get_view('2')
        self.assert_(isinstance(v, BufferProxy))
        self.assertRaises(Error, s.get_view, '3')

        s = gsdl2.Surface((5, 7), 0, 24)
        self.assertRaises(Error, s.get_view, '0')
        self.assertRaises(Error, s.get_view, '1')
        v = s.get_view('2')
        ...
        s = gsdl2.Surface((5, 7), gsdl2.SRCALPHA, 32)
        v = s.get_view('2')
        self.assert_(isinstance(v, BufferProxy))
        v = s.get_view('3')
        self.assert_(isinstance(v, BufferProxy))
        ...
        s = gsdl2.Surface((2, 4), gsdl2.SRCALPHA, 32)
    ...
    try:
        gsdl2.bufferproxy.get_segcount
    ...
    def OLDBUF_get_buffer_oldbuf(self):
        from gsdl2.bufferproxy import get_segcount, get_write_buffer
    ...
    def test_set_colorkey(self):
        ...
        # __doc__ (as of 2008-06-25) for gsdl2.surface.Surface.set_colorkey:

          # Surface.set_colorkey(Color, flags=0): return None
          # Surface.set_colorkey(None): return None
          # Set the transparent colorkey

        s = gsdl2.Surface((16,16), gsdl2.SRCALPHA, 32)
    ...
    def todo_test_blit(self):
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.blit:
          ...
          # special_flags new in gsdl2 1.8.

        self.fail()

    def test_blit__SRCALPHA_opaque_source(self):
        src = gsdl2.Surface( (256,256), SRCALPHA ,32)
        dst = src.copy()
    ...
    def todo_test_blit__SRCALPHA_to_SRCALPHA_non_zero(self): #TODO
        ...
        s = gsdl2.Surface(size, gsdl2.SRCALPHA, 32)
        s2 = s.copy()
    ...
    def test_blit__SRCALPHA32_to_8(self):
        ...
        target = gsdl2.Surface((11, 8), 0, 8)
        color = target.get_palette_at(2)
        source = gsdl2.Surface((1, 1), gsdl2.SRCALPHA, 32)
    ...
    def test_image_convert_bug_131(self):
        ...
        # https://bitbucket.org/gsdl2/gsdl2/issue/131/unable-to-surfaceconvert-32-some-1-bit
        gsdl2.display.init()
        gsdl2.display.set_mode((640,480))

        im  = gsdl2.image.load(example_path(os.path.join("data", "city.png")))
        im2 = gsdl2.image.load(example_path(os.path.join("data", "brick.png")))
    ...
    def todo_test_convert(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.convert:
    ...
    def todo_test_convert_alpha(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.convert_alpha:
    ...
    def todo_test_get_abs_offset(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.get_abs_offset:
    ...
    def todo_test_get_abs_parent(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.get_abs_parent:
    ...
    def test_get_at(self):
        surf = gsdl2.Surface((2, 2), 0, 24)
        c00 = gsdl2.Color(1, 2, 3)
        c01 = gsdl2.Color(5, 10, 15)
        c10 = gsdl2.Color(100, 50, 0)
        c11 = gsdl2.Color(4, 5, 6)
        surf.set_at((0, 0), c00)
        surf.set_at((0, 1), c01)
        surf.set_at((1, 0), c10)
        surf.set_at((1, 1), c11)
        c = surf.get_at((0, 0))
        self.failUnless(isinstance(c, gsdl2.Color))
    ...
    def test_get_at_mapped(self):
        color = gsdl2.Color(10, 20, 30)
        for bitsize in [8, 16, 24, 32]:
            surf = gsdl2.Surface((2, 2), 0, bitsize)
            surf.fill(color)
    ...
    def todo_test_get_bitsize(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.get_bitsize:
    ...
    def todo_test_get_clip(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.get_clip:
    ...
    def todo_test_get_colorkey(self):
        ...
        colorkey = gsdl2.Color(20, 40, 60)
        surf.set_colorkey(colorkey)
        ck = surf.get_colorkey()
        self.failUnless(isinstance(ck, gsdl2.Color))
        self.failUnlessEqual(ck, colorkey)

    def todo_test_get_height(self):

        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.get_height:
    ...
    def todo_test_get_locked(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.get_locked:
    ...
    def todo_test_get_locks(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.get_locks:
    ...
    def todo_test_get_losses(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.get_losses:
          ...
          # in a mapped integer.
          #
          # This value is not needed for normal gsdl2 usage.

        self.fail()

    def todo_test_get_masks(self):

        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.get_masks:
    ...
    def todo_test_get_offset(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.get_offset:
    ...
    def test_get_palette(self):
        ...
        try:
            ...
            gsdl2.display.set_mode((100, 50))
            surf = gsdl2.Surface((2, 2), 0, 8)
    ...
    def test_get_palette_at(self):
        ...
        try:
            gsdl2.display.set_mode((100, 50))
            surf = gsdl2.Surface((2, 2), 0, 8)
            color = gsdl2.Color(1, 2, 3, 255)
            surf.set_palette_at(0, color)
            color2 = surf.get_palette_at(0)
            self.failUnless(isinstance(color2, gsdl2.Color))
    ...
    def todo_test_get_pitch(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.get_pitch:
    ...
    def todo_test_get_shifts(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.get_shifts:
    ...
    def todo_test_get_size(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.get_size:
    ...
    def todo_test_lock(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.lock:
          ...
          # Surface can often not be displayed or managed by gsdl2.
          #
          ...
          #
          # All gsdl2 functions will automatically lock and unlock the Surface
    ...
    def test_map_rgb(self):
        ...
        surf = gsdl2.Surface((5, 5), SRCALPHA, 32)
    ...
    def todo_test_mustlock(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.mustlock:
    ...
    def todo_test_set_alpha(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.set_alpha:
          ...
          #
          # The optional flags argument can be set to gsdl2.RLEACCEL to provide
        ...
        s = gsdl2.Surface((1,1), SRCALHPA, 32)
        s.fill((1, 2, 3, 4))
        s.set_alpha(None)
    ...
    def test_set_palette(self):
        palette = [gsdl2.Color(i, i, i) for i in range(256)]
        ...
        try:
            ...
            for i in range(256):
                ...
                self.failUnlessEqual(surf.get_at((0, 0)), c,
                                     "palette color %i" % (i,))
            for i in range(10):
                palette[i] = gsdl2.Color(255 - i, 0, 0)
    ...
    def test_subsurface(self):
        ...
        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.subsurface:
        ...
        # Issue 2 at Bitbucket.org/gsdl2/gsdl2
        surf = gsdl2.Surface.__new__(gsdl2.Surface)
        self.assertRaises(gsdl2.error, surf.subsurface, (0, 0, 0, 0))



    def todo_test_unlock(self):

        # __doc__ (as of 2008-08-02) for gsdl2.surface.Surface.unlock:

          # Surface.unlock(): return None
          # unlock the Surface memory from pixel access
          #
          # Unlock the Surface pixel data after it has been locked. The unlocked
          # Surface can once again be drawn and managed by gsdl2. See the
    ...
    def test_unmap_rgb(self):
        ...
        try:
            ...
            self.failUnless(isinstance(unmapped_c, gsdl2.Color))
        finally:
            gsdl2.quit()
        ...
        for flags, bitsize in formats:
            surf = gsdl2.Surface((2, 2), flags, bitsize)
    ...
    def test_scroll(self):
        ...
        for bitsize, dx, dy in scrolls:
            surf = gsdl2.Surface((10, 10), 0, bitsize)
            surf.fill((255, 0, 0))
        ...
        surf = gsdl2.Surface((4, 4), gsdl2.SRCALPHA, 32)
...
class SurfaceGetBufferTest (unittest.TestCase):
    ...
    lilendian = gsdl2.get_sdl_byteorder () == gsdl2.LIL_ENDIAN
    ...
    def test_array_interface(self):
        self._check_interface_2D(gsdl2.Surface((5, 7), 0, 8))
        self._check_interface_2D(gsdl2.Surface((5, 7), 0, 16))
        self._check_interface_2D(gsdl2.Surface((5, 7), gsdl2.SRCALPHA, 16))
        self._check_interface_3D(gsdl2.Surface((5, 7), 0, 24))
        self._check_interface_3D(gsdl2.Surface((8, 4), 0, 24)) # No gaps
        self._check_interface_2D(gsdl2.Surface((5, 7), 0, 32))
        self._check_interface_3D(gsdl2.Surface((5, 7), 0, 32))
        self._check_interface_2D(gsdl2.Surface((5, 7), gsdl2.SRCALPHA, 32))
        self._check_interface_3D(gsdl2.Surface((5, 7), gsdl2.SRCALPHA, 32))
    ...
    def test_array_interface_masks(self):
        ...
        if s_masks[0:3] == masks or s_masks[0:3] == masks[::-1]:
            ...
            self._check_interface_3D(gsdl2.Surface(sz, 0, 32, masks))
        s = gsdl2.Surface(sz, 0, 24)
        s_masks = list(s.get_masks())
        masks = [0xff, 0xff00, 0xff0000]
        if s_masks[0:3] == masks or s_masks[0:3] == masks[::-1]:
            masks = s_masks[2::-1] + s_masks[3:4]
            self._check_interface_3D(gsdl2.Surface(sz, 0, 24, masks))
        ...
        self.assertRaises(ValueError,
                          gsdl2.Surface(sz, 0, 24, masks).get_view, '3')
    ...
    def test_array_interface_alpha(self):
        for shifts in [[0, 8, 16, 24], [8, 16, 24, 0],
            ...
            s = gsdl2.Surface((4, 2), gsdl2.SRCALPHA, 32, masks)
    ...
    def test_array_interface_rgb(self):
        for shifts in [[0, 8, 16, 24], [8, 16, 24, 0],
            ...
            for plane in range(3):
                s = gsdl2.Surface((4, 2), 0, 24)
                self._check_interface_rgba(s, plane)
                s = gsdl2.Surface((4, 2), 0, 32)
                self._check_interface_rgba(s, plane)
...
class SurfaceBlendTest (unittest.TestCase):
    ...
    def _make_surface(self, bitsize, srcalpha=False, palette=None):
        ...
        if srcalpha:
            flags |= SRCALPHA
        surf = gsdl2.Surface(self.surf_size, flags, bitsize)
        if bitsize == 8:
    ...
    def test_blit_blend(self):
        ...
        for src in sources:
            ...
            for dst in destinations:
                for blend_name, dst_color, op in blend:
                    ...
                    dst.blit(src,
                              (0, 0),
                              special_flags=getattr(gsdl2, blend_name))
        ...
        masks = src.get_masks()
        dst = gsdl2.Surface(src.get_size(), 0, 32,
        ...
        src = gsdl2.Surface(pat.get_size(), 0, 32, masks)
        self._fill_surface(src)
        dst = gsdl2.Surface(src.get_size(), 0, 32, masks)
        for blend_name, dst_color, op in blend:
            p = []
            for src_color in self._test_palette:
                c = [op(dst_color[i], src_color[i]) for i in range(3)]
    ...
    def test_blit_blend_rgba(self):
        ...
        masks = src.get_masks()
        dst = gsdl2.Surface(src.get_size(), SRCALPHA, 32,
        ...
        src = gsdl2.Surface((8, 10), SRCALPHA, 32)
        dst = gsdl2.Surface((8, 10), SRCALPHA, 32)
        tst = gsdl2.Surface((8, 10), SRCALPHA, 32)
        src.fill((1, 2, 3, 4))
    ...
    def test_blit_blend_big_rect(self):
        ...
        area = (1, 1, 30, 30)
        s1 = gsdl2.Surface((4, 4), 0, 32)
        r = s1.fill(special_flags=gsdl2.BLEND_ADD, color=color, rect=area)
        self.assertEquals(gsdl2.Rect((1, 1, 3, 3)), r)
        self.assert_(s1.get_at((0, 0)) == (0, 0, 0, 255))
        self.assert_(s1.get_at((1, 1)) == color)


        black = gsdl2.Color("black")
        red = gsdl2.Color("red")
        self.assertNotEqual(black, red)

        surf = gsdl2.Surface((10, 10), 0, 32)
        surf.fill(black)
        subsurf = surf.subsurface(gsdl2.Rect(0, 1, 10, 8))
        self.assertEqual(surf.get_at((0, 0)), black)
        self.assertEqual(surf.get_at((0, 9)), black)

        subsurf.fill(red, (0, -1, 10, 1), gsdl2.BLEND_RGB_ADD)
        self.assertEqual(surf.get_at((0, 0)), black)
        self.assertEqual(surf.get_at((0, 9)), black)

        subsurf.fill(red, (0, 8, 10, 1), gsdl2.BLEND_RGB_ADD)
        self.assertEqual(surf.get_at((0, 0)), black)
        self.assertEqual(surf.get_at((0, 9)), black)
        ...
        for dst in destinations:
            ...
            for blend_name, fill_color, op in blend:
                ...
                for dc in dst_palette:
                    ...
                    c = dst.unmap_rgb(dst.map_rgb(c))
                    p.append(c)
                dst.fill(fill_color, special_flags=getattr(gsdl2, blend_name))
                self._assert_surface(dst, p, ", %s" % blend_name)
...
class SurfaceSelfBlitTest(unittest.TestCase):
    ...
    def test_overlap_check(self):
        ...
        # not properly handled by SDL 1.2.13, so gsdl2 does them.
        bgc = (0, 0, 0, 255)
        ...
        overlaps = [(0, 0, 1, 0, (50, 0)),
                    ...
                    (49, 0, 0, 1, (0, 2)),
                    (49, 0, 0, 49, (0, 98))]
        surfs = [gsdl2.Surface((100, 100), SRCALPHA, 32)]
        surf = gsdl2.Surface((100, 100), 0, 32)
        surf.set_alpha(255)
        surfs.append(surf)
        surf = gsdl2.Surface((100, 100), 0, 32)
    ...
    def test_colorkey(self):
        ...
        gsdl2.display.set_mode((100, 50))  # Needed for 8bit surface
        bitsizes = [8, 16, 24, 32]
    ...
    def test_blend(self):
        ...
        for bitsize in bitsizes:
            ...
            for blend in blends:
                ...
                comp.blit(surf, (3, 0),
                          special_flags=getattr(gsdl2, blend))
                surf.blit(surf, (3, 0),
                          special_flags=getattr(gsdl2, blend))
                self._assert_same(surf, comp)
    ...
    def test_subsurface(self):
        ...
        self.failUnlessRaises(gsdl2.error, do_blit, surf, sub)
...
class SurfaceFillTest(unittest.TestCase):
    def test_fill(self):
        ...
        try:
            ...
            screen.fill((255, 0, 0, 127), (160, 30, 320, 30), gsdl2.BLEND_ADD)
            screen.fill((0, 127, 127, 127), (160, 60, 320, 30), gsdl2.BLEND_SUB)
            screen.fill((0, 63, 63, 127), (160, 90, 320, 30), gsdl2.BLEND_MULT)
            screen.fill((0, 127, 127, 127), (160, 120, 320, 30), gsdl2.BLEND_MIN)
            screen.fill((127, 0, 0, 127), (160, 150, 320, 30), gsdl2.BLEND_MAX)
            screen.fill((255, 0, 0, 127), (160, 180, 320, 30), gsdl2.BLEND_RGBA_ADD)
            screen.fill((0, 127, 127, 127), (160, 210, 320, 30), gsdl2.BLEND_RGBA_SUB)
            screen.fill((0, 63, 63, 127), (160, 240, 320, 30), gsdl2.BLEND_RGBA_MULT)
            screen.fill((0, 127, 127, 127), (160, 270, 320, 30), gsdl2.BLEND_RGBA_MIN)
            screen.fill((127, 0, 0, 127), (160, 300, 320, 30), gsdl2.BLEND_RGBA_MAX)
            screen.fill((255, 0, 0, 127), (160, 330, 320, 30), gsdl2.BLEND_RGB_ADD)
            screen.fill((0, 127, 127, 127), (160, 360, 320, 30), gsdl2.BLEND_RGB_SUB)
            screen.fill((0, 63, 63, 127), (160, 390, 320, 30), gsdl2.BLEND_RGB_MULT)
            screen.fill((0, 127, 127, 127), (160, 420, 320, 30), gsdl2.BLEND_RGB_MIN)
            screen.fill((255, 0, 0, 127), (160, 450, 320, 30), gsdl2.BLEND_RGB_MAX)
